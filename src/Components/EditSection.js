...
export const EditSection = ({section, id, visible, setVisible, setUser, user}) => {
    ...
    <Modal
            ...
            size={5}>
                ...
                <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                    ...
                    <Text style={{paddingRight: "20%", fontWeight: "500", fontFamily: "Avenir Next", fontSize: 18, paddingVertical: "2.5%",width: "100%", textAlign: 'center'}}>Edit Section</Text>
                    { (newSection != section && newSection!="") ?
                    <TouchableOpacity  onPress={()=>{updateSection(), setVisible(false)}} style={{flexDirection: 'row', position: 'absolute', right: "5%"}}>
                    ...
                    labelField={'label'}
                    valueField={'value'}
                    placeholder={(newSection=="") ? 'Section' : newSection.value}
